...
<article id="post-2675" class="post-2675 page type-page status-publish hentry">
	...
	<div class="wpb_text_column wpb_content_element wpb_animate_when_almost_visible wpb_zoomIn zoomIn vision-box" >
		<div class="wpb_wrapper">
			<p>The&nbsp;Department of Computer Science &amp; Engineering (CSE)&nbsp;at&nbsp;APJ Abdul Kalam University, Indore, is a premier academic hub dedicated to excellence in&nbsp;education, research, and innovation&nbsp;in the field of computing and technology. With a strong emphasis on both&nbsp;theoretical foundations&nbsp;and&nbsp;practical applications, the department equips students with the skills needed to thrive in the&nbsp;rapidly evolving tech industry.</p>
<p>&nbsp;</p>
<h4>Key</h4>
	...
	<div class="wpb_text_column wpb_content_element mission-box" >
		<div class="wpb_wrapper">
			<h4>Highlights of the Department</h4>
<p>&nbsp;</p>
<p class="ds-markdown-paragraph">🔹&nbsp;Industry-Aligned Curriculum</p>
<p class="ds-markdown-paragraph">🔹&nbsp;Research &amp; Innovation</p>
<p class="ds-markdown-paragraph">🔹&nbsp;State-of-the-Art Infrastructure</p>
<p class="ds-markdown-paragraph">🔹&nbsp;Placements &amp; Industry Connect</p>
<p class="ds-markdown-paragraph">🔹&nbsp;Visionary Leadership</p>
	...
	<div class="wpb_text_column wpb_content_element wpb_animate_when_almost_visible wpb_zoomIn zoomIn vc_custom_1767614716832 vision-box" >
		<div class="wpb_wrapper">
			<p>To be a globally recognized center of excellence in computer science and engineering, fostering innovation and producing skilled professionals who drive technological advancements.</p>
<p>&nbsp;</p>
<p>By integrating&nbsp;<strong>world-class education, disruptive research, and global partnerships</strong>, we aim to shape the future of technology while upholding the legacy of Dr. APJ Abdul Kalam.</p>
...
<ul>
<li>
<p class="ds-markdown-paragraph">To provide high-quality education through a well-structured curriculum and hands-on learning.</p>
</li>
<li>
<p class="ds-markdown-paragraph">To promote cutting-edge research in artificial intelligence, data science, cybersecurity, cloud computing, and more.</p>
</li>
<li>
<p class="ds-markdown-paragraph">To nurture problem-solving skills, creativity, and ethical values in students.</p>
</li>
<li>
<p class="ds-markdown-paragraph">To collaborate with industry and academia to bridge the gap between theory and real-world applications.</p>
</li>
</ul>
</li>
</ul>
...
<div class="wpb_wrapper">
<p>School of Engineering has been established as one of the leading engineering institutes of the University. From the time of establishment, SOE has focused on creating niche in technical field. The institute is committed to creating an ambiance for nurturing innovation, creativity and excellence in our students. I commit that we will put in our best efforts to develop SOE as a top-notch technological institute of global standards. We have a decided team of techno managers who are result-oriented, ambitious, rational and competitive with high risk taking ability and inquisitive mind. They are challenged by innovation at the same time have an understanding of their organization and a belief in their colleagues. Well qualified dedicated faculty, rich library, cutting- edge equipped laboratories and workshops, hi- tech class rooms and interactive atmosphere create intellectually vibrant environment in the institute. We have adopted the latest teaching-learning methodologies and the emerging pedagogic aids. We look to develop analytical thinking, practical and creative problem-solving strengths in our students. At the same time, we encourage students to grow as effective individuals with a strong set of ethics, communication skills and zeal to succeed. I assure you that the students graduating from our institute will develop a healthy blend of knowledge as well as skills along with a great personality.</p>
<p>Our core principle includes visionary management, matured and stable leadership, senior dedicated faculty, state-of-the-art infrastructure, high academic standards, strict academic discipline, and remarkable co-curricular and extracurricular activities. Special emphasis is given to the growth of the students such as all round personality development, opportunity of international exposure, character and competence building, industrial training and online projects etc.</p>
<p>I welcome you all in a new world of education for learning &amp; implementing new concepts to face new challenges of the current global industry.
</p></div>
</div>
<div class="wpb_text_column wpb_content_element">
<div class="wpb_wrapper"></div>
	...
	<div class="wpb_text_column wpb_content_element" >
		<div class="wpb_wrapper">
			<p style="text-align: right;"><strong>Dr Santosh Panwar</strong></p>
<p style="text-align: right;">Qualification M. Tech. (Opto. Electronics), Ph.D. (Applied Physics)</p>

		</div>
	</div>
</div></div></div></div></div></div><div class="vc_tta-panel" id="1750747217311-04a868cf-eeff" data-vc-content=".vc_tta-panel-body"><div class="vc_tta-panel-heading"><h4 class="vc_tta-panel-title"><a href="#1750747217311-04a868cf-eeff" data-vc-accordion data-vc-container=".vc_tta-container"><span class="vc_tta-title-text">Faculty &amp; Staff Profile</span></a></h4></div><div class="vc_tta-panel-body"><h2 style="text-align: center" class="vc_custom_heading vc_do_custom_heading" >Faculty &amp; Staff</h2><div class="vc_row wpb_row vc_inner vc_row-fluid"><div class="wpb_column vc_column_container vc_col-sm-3"><div class="vc_column-inner"><div class="wpb_wrapper"></div></div></div><div class="wpb_column vc_column_container vc_col-sm-3"><div class="vc_column-inner"><div class="wpb_wrapper"></div></div></div><div class="wpb_column vc_column_container vc_col-sm-3"><div class="vc_column-inner"><div class="wpb_wrapper"></div></div></div><div class="wpb_column vc_column_container vc_col-sm-3"><div class="vc_column-inner"><div class="wpb_wrapper"></div></div></div></div></div></div><div class="vc_tta-panel" id="1750747218570-d2853e54-a5be" data-vc-content=".vc_tta-panel-body"><div class="vc_tta-panel-heading"><h4 class="vc_tta-panel-title"><a href="#1750747218570-d2853e54-a5be" data-vc-accordion data-vc-container=".vc_tta-container"><span class="vc_tta-title-text">Infrastructure</span></a></h4></div><div class="vc_tta-panel-body"><div class="vc_row wpb_row vc_inner vc_row-fluid"><div class="wpb_column vc_column_container vc_col-sm-6"><div class="vc_column-inner"><div class="wpb_wrapper">
