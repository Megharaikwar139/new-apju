...
$page_data = [];
try {
    $stmt = $pdo->prepare("SELECT * FROM about_pages_config WHERE page_slug = 'governing-body'");
    $stmt->execute();
    $page_data = $stmt->fetch(PDO::FETCH_ASSOC) ?: [];
} catch (Exception $e) {}

$hero_eyebrow = !empty($page_data['hero_eyebrow']) ? $page_data['hero_eyebrow'] : 'STATUTORY GOVERNANCE';
$page_title = !empty($page_data['page_title']) ? $page_data['page_title'] : 'Governing Body';
$hero_subtitle = !empty($page_data['hero_subtitle']) ? $page_data['hero_subtitle'] : 'Supreme Authority of Dr. A.P.J. Abdul Kalam University, Indore';
$doc_title_1 = !empty($page_data['doc_title_1']) ? $page_data['doc_title_1'] : 'Official Governing Body Constitution & Notifications';
$doc_file_1 = !empty($page_data['doc_file_1']) ? $page_data['doc_file_1'] : 'uploads/2026/03/Governing-Body_final_01.pdf';
$main_content = !empty($page_data['main_content']) ? $page_data['main_content'] : '<p class="text-muted-custom small lh-base mb-4">The Governing Body is the apex executive and policy-making authority of Dr. A.P.J. Abdul Kalam University, constituted in compliance with the M.P. Niji Vishwavidyalaya Adhiniyam. It oversees all academic, administrative, and strategic directions of the University.</p>';
?>
                ...
                <article class="inner-main-card">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="small text-muted">Statutory gazetted notification & official members list</div>
                                    </td>
                    ...
                    <div class="p-4 rounded-4 mt-4 border border-custom" style="background: #fcfbf9;">
                        ...
                        <ul class="small text-muted-custom lh-base mb-0 ps-3">
                            <li class="mb-1.5">Formulation of broad policies, statutory governance, and development guidelines.</li>
                            <li class="mb-1.5">Review and approval of the annual budget, academic programs, and financial reports.</li>
                            <li class="mb-1.5">Creation of academic and administrative posts and institutional infrastructure expansion.</li>
                        </ul>
                    </div>
