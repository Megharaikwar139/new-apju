<?php 
$pageTitle = "University Fee Structure 2026-27 - Dr. APJ Abdul Kalam University, Indore";
include 'header.php'; 
?>
                ...
                <article class="inner-main-card">
                    ...
                    <div class="intro-highlight-card mb-5">
                        <div class="d-flex align-items-center gap-3.5">
                            ...
                            <div>
                                <h3 class="font-serif text-primary fs-4 fw-bold mb-1">Approved Academic Fee Structure</h3>
                                <p class="mb-0 text-muted-custom" style="font-size: 0.95rem; line-height: 1.7;">
                                    Tuition fees at Dr. A.P.J. Abdul Kalam University are structured in strict compliance with statutory regulatory bodies (AICTE, PCI, BCI, NCTE &amp; MP Higher Education Regulatory Commission) ensuring supreme quality education with full affordability.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="luxury-table table table-hover mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 170px;" class="text-end">Tuition Fee / Year</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-end fw-bold text-primary font-serif fs-6">₹ 25,000/-</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end fw-bold text-primary font-serif fs-6">₹ 30,000/-</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="text-end fw-bold text-primary font-serif fs-6">₹ 50,000/-</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="text-end fw-bold text-primary font-serif fs-6">₹ 60,000/-</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end fw-bold text-primary font-serif fs-6">₹ 70,000/-</td>
                                    </tr>
                                    <tr>
