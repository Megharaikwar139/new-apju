...
$bodyClass = 'wp-singular page-template page-template-pages page-template-inner-page page-template-pagesinner-page-php page page-id-2144 wp-custom-logo wp-theme-aku no-sidebar wpb-js-composer js-comp-ver-8.7.2 vc_responsive';
$useLiveReferenceAssets = true;
$activeDepartmentPage = 'mechanical-engineering-soe';
include 'header.php';
?>
...
<article id="post-2144" class="post-2144 page type-page status-publish hentry">
	...
	<div class="wpb_text_column wpb_content_element wpb_animate_when_almost_visible wpb_zoomIn zoomIn vision-box" >
		<div class="wpb_wrapper">
			<p>The Department of Mechanical Engineering at Dr. A.P.J. Abdul Kalam University, Indore, offers a future-focused education designed to prepare students for real-world challenges and rewarding careers. With a strong foundation in mechanical engineering principles, the program emphasizes hands-on learning, interdisciplinary exposure, and innovative problem-solving. Guided by experienced faculty and supported by modern labs and a cutting-edge curriculum, students gain the skills and knowledge needed to excel in industries such as manufacturing, thermal systems, automotive design, robotics, and more. Whether you&#8217;re a student planning your future, a parent seeking quality education, or a recruiter looking for capable professionals, our department is committed to producing industry-ready engineers.</p>
	...
	<div class="wpb_text_column wpb_content_element mission-box" >
		<div class="wpb_wrapper">
			<p>Key Highlights of the Department<br />
• Industry-Aligned Curriculum: Designed in accordance with AICTE guidelines and tailored to meet evolving industry demands.<br />
• Experienced Faculty: Learn from experts with specialized knowledge in thermal engineering, design, and manufacturing.<br />
• Advanced Laboratories: Hands-on training in modern labs including Fluid Mechanics, Heat Transfer, CAD/CAM, and more.<br />
• Industry Exposure: Regular industrial visits and expert guest lectures connect students with real-world practices.<br />
• Strategic Partnerships: Collaborations with key companies in the manufacturing and automotive sectors enhance learning and career opportunities.<br />
• Focus on the Future: Emphasis on sustainability, renewable energy, and smart manufacturing technologies.<br />
• Career-Ready Training: Dedicated placement assistance and skill development programs to ensure successful careers.</p>
<p>&nbsp;</p>
	...
	<div class="wpb_text_column wpb_content_element wpb_animate_when_almost_visible wpb_zoomIn zoomIn vc_custom_1767873883112 vision-box" >
		<div class="wpb_wrapper">
			<p>To be a leading hub for mechanical engineering education and innovation—empowering students to become skilled, ethical professionals who contribute to sustainable technologies and meet the evolving needs of industry and society.</p>
	...
	<div class="wpb_text_column wpb_content_element wpb_animate_when_almost_visible wpb_zoomIn zoomIn mission-box" >
		<div class="wpb_wrapper">
			<p class="ds-markdown-paragraph">To equip students with practical skills, industry-relevant knowledge, and a mindset for innovation through quality education, hands-on training, and real-world collaboration. We aim to strengthen ties with industry through outreach, consultancy, and joint efforts in promoting sustainable and impactful engineering practices</p>
...
<p style="text-align: right;">Qualification: Ph.D. (CSE), M.Tech. (CS)</p>
    ...
    <img decoding="async" src="uploads/2026/01/ALOK_HOD_ME_SOE.jpeg" alt="Mr. Alok">
  ...
  <div class="profile-card">
    <img decoding="async" src="uploads/2026/01/mohit_chouhan_soe_me.jpeg" alt="Mohit Chouhan">
    <div class="profile-content">
      <h4>Mohit Chouhan</h4>
      <p>Professor</p>
    </div>
  ...
  <div class="profile-card">
    <img decoding="async" src="uploads/2026/01/risabhdev-singh-parihar-_SOE_ME.jpeg" alt="Risabhdev Singh Parihar">
    <div class="profile-content">
      <h4>Risabhdev Singh Parihar</h4>
      <p>Professor</p>
    </div>
  </div>
  ...
  <div class="profile-card">
    <img decoding="async" src="uploads/2026/01/satyaprakash-tiwari-_soe_me.jpeg" alt="Satyaprakash Tiwari">
    <div class="profile-content">
      <h4>Satyaprakash Tiwari</h4>
      <p>Professor</p>
    </div>
  </div>
  ...
  <p>Wi-Fi enabled smart campuses with seamless digital connectivity. High speed internet.</p>
	...
	<div class="wpb_text_column wpb_content_element file_page2" >
		<div class="wpb_wrapper">
			<h2><em>SO/PO SOE Mechanical</em></h2><p><em>No files found in this category.</em></p>
	...
	<div class="wpb_text_column wpb_content_element file_page2" >
		<div class="wpb_wrapper">
			<h2><em>Activities SOE Mechanical</em></h2><p><em>No files found in this category.</em></p>
	...
	<div class="wpb_text_column wpb_content_element file_page2" >
		<div class="wpb_wrapper">
			<h2><em>Time Table SOE Mechanical</em></h2><table class='filr-table'><tr><th>Title</th></tr><tr>
                             <td><a href='uploads/2026/01/time-table-BE.pdf' target='_blank'>time table BE</a></td>
                          </tr></table>
...
</div></div></div><div class="vc_tta-panel" id="1767878520104-539dc739-c180" data-vc-content=".vc_tta-panel-body"><div class="vc_tta-panel-heading"><h4 class="vc_tta-panel-title"><a href="#1767878520104-539dc739-c180" data-vc-accordion data-vc-container=".vc_tta-container"><span class="vc_tta-title-text">Notice Board</span></a></h4></div><div class="vc_tta-panel-body">
	<div class="wpb_text_column wpb_content_element file_page2" >
		<div class="wpb_wrapper">
			<h2><em>Notice Board SOE Mechanical</em></h2><p><em>No files found in this category.</em></p>
